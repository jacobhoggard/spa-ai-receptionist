 ...
 * Currently mocked for testing. Real implementations call Cliniko API, Twilio, etc.
 */

/**
 * Mock data for testing (in real implementation, calls Cliniko API)
 */
...
async function toolCheckAvailability(inputs) {
  ...
  // - Call Cliniko API with service_id, date range
...
async function toolCreateBooking(inputs) {
  ...
  // In real implementation:
  // - Call Cliniko API: POST /appointments
...
async function toolRescheduleBooking(inputs) {
  ...
  // In real implementation:
  // - Call Cliniko API: PUT /appointments/{id}
...
/**
 * Tool: cancel_booking
 * Cancel appointment (respects cancellation policy)
 */
async function toolCancelBooking(inputs) {
  ...
  // In real implementation:
  // - Call Cliniko API: DELETE /appointments/{id}
...
async function toolLookupBookingByPhone(inputs) {
  ...
  // In real implementation:
  // - Query Cliniko API: GET /patients?phone={phone}
